////////////////////////////////////////////////////////////////////////////////
// File Name  :2021202045_adv_server.c                                        //
// Date       :2023/05/10                                                     //  
...
//               classify appropriate ip address of client.                   //
////////////////////////////////////////////////////////////////////////////////
#include <stdio.h>
#include <string.h>
...
// Output: void                                                   //
// Purpose: exit according to terminaton key                      //                                  
////////////////////////////////////////////////////////////////////
...
{   
   ...
   alarm(10); //alarm per 10 sec
    while(1){
        ...
        pid_t child;       //get child process's pid
        ...
        signal(SIGTSTP,signalHandler); //get signal
        ...
        exit(0); //exit 0 to parent process
        }
        else{
            wait(&status); //wait child process and get termination state
            ci_array[client_num].pid = child; //store pid of child process
...
void alarm_handler(int sig){
    ...
    for(int i = start; i<=client_num; i++){ //start~client_num
        ...
        printf("%d         %s      %d       %d      %s",ci_array[i].cum_num,ci_array[i].ip_addr,ci_array[i].pid,ci_array[i].port,ct); //print information
    }
